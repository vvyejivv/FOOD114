...
#addrBtn:hover {
						...
						<td>
							<div>
								<input type="text" style="width: 150px; margin-right: 5px;"
									placeholder="이메일을 입력해주세요." v-model="businessEmail" @keyup="emailChange()"> <span
				...
				<table>
					<tr>
						...
						<td style="font-size: 20px; font-weight: 500;"><label><input
								type="checkbox">전체 동의합니다.</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox">이용약관 동의(필수)</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox">개인정보 수집·이용
								동의(필수)</label></td>
					</tr>
					<tr>
						<td><label><input type="checkbox">할인쿠폰 등
								혜택/정보 수신 동의(선택)</label></td>
					</tr>
				</table>
				<div style="border-bottom: 1px solid #ccc; padding-top: 25px;"></div>
				<div
	...
	<footer>
		...
		<div style="clear: both; font-size: 12px;">
			...
			<div>
				대표이사 : 박경빈 <span class="partition"> | </span>사업자등록번호 : 010-6382-4246
			</div>
	...
	var app = new Vue(
			{
				...
				methods : {
					...
					signUp : function() {
						var self = this;
						let domain = self.businessDomain == "" ? self.businessTempDomain : self.businessDomain;
