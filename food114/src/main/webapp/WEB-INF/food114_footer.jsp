...
<body>
	...
	<div id="footer-container">
		<div id="footer-contents-left">
			...
			<div id="footer-text">
				<span>더조은아카데미</span> <span>|</span> <span>인천광역시 부평구 부평동</span> <span>|</span>
		...
		<div id="footer-contents-right">
			...
			<div id="footer-link">
				<span>이용약관</span> <span>|</span> <span>이용안내</span> <span>|</span> <span>개인정보처리방침</span>
				<span>|</span> <span>사이트맵</span>
			</div>
		</div>
	</div>
</body>
