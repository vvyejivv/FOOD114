		...
		<div id="app">
			<div class="login_Container">
				<div class="login_Box">
					...
					<div id="login_Form">
						<input type="text" placeholder="아이디" class="idPwd_input" v-model="bizId" :style="{border: flg? '1px solid red' : '1px solid #ccc'}" @change="fnInput"> 
						...
						<button class="join_button" @click="fnJoin">사업자 회원가입</button>
					</div>
					<ul class="login_find">
