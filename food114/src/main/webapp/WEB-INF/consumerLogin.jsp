			...
			<div class="login_Container" style="width: fit-content; margin: 0px auto; margin-top: 150px; ">
				<div class="login_Box" style="width: fit-content">
					...
					<div id="login_Form" style="width: fit-content;">
						<input type="text" placeholder="아이디" class="idPwd_input" v-model="userId"  @change="fnInput" style="width: 400px; height: 32px; border: 1px solid #ededed; border-radius: 8px;"> 
						<div class="login_text" v-html="idErrormsg"></div>
						<input type="password" placeholder="비밀번호" class="idPwd_input" v-model="pwd"   @keyup.enter="fnLogin" @change="fnInput" style="width: 400px;height: 32px; border: 1px solid #ededed; border-radius: 8px;">  
