					...
					<div class="login_Box" style="width: fit-content">
						...
						<div id="login_Form" style="width: fit-content;">
							...
							<input type="password" placeholder="비밀번호" class="idPwd_input"
								v-model="pwd" @keyup.enter="fnLogin" @change="fnInput"
								style="width: 400px; height: 32px; border: 1px solid #ededed; border-radius: 8px;">
							...
							<button class="login_button" @click="fnLogin" style="">로그인</button>
							<button class="join_button" @click="fnJoin"
								style="height: 58px; border-radius: 8px; border: 1px solid #ededed; color: #5f5f5f;">회원가입</button>
						</div>
						<!-- <ul class="login_find">
