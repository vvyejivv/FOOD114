...
<body style="margin: 0px;">
	...
	<div id="app" style="width: 1920px; margin: 0px auto;">
		<div style="width: 1420px; height: 650px; border: 1px solid #EDEDED; margin: 40px auto; border-radius: 5px;">
            <div style="width: 1420px; ">
                ...
                <div style="display: flex; justify-content: center; gap: 10px; margin-top: 20px;">
                    <div style="width: fit-content; padding: 10px 60px; border-radius: 8px; background-color: #FF8002; color: #FFFFFF; cursor: pointer;" @click="fnPageChang('home')">HOME</div>
                    <div style="width: fit-content; padding: 10px 55px; border-radius: 8px; border: 1px solid #EDEDED; color:#5F5F5F;  background-color: #FFFFFF; cursor: pointer;" @click="fnPageChang('myPage')">마이페이지</div>
                </div>
            </div>
            <div style="width: 1420px; height: 400px;">
                <div style="width: fit-content; height: 10px; margin: 40px auto; font-size: 16px;">주문내역</div>
                <div>
                    <table class="orderListTable" style="margin: 0px auto; border-top: 1px solid #c0c0c0;">
                        <tr>
                            <th
