		...
		<section>
			<div style="width: 1420px; display: flex; margin: 0px auto;">
				...
				<div id="app" v-cloak>
					<div class="content">
						<h2>
							<a style="font-size: 25px; color: #747171;"> <span
								style="color: #ff7f00; font-weight: bold;">| </span>MY정보 확인/변경
							</a>
						</h2>
						<div>
							<div class="table">
								...
								<div class="row">
									...
									<div class="cell2">
										<div style="width: fit-content;">{{info.name}}</div>
								...
								<div class="row">
									...
									<div class="cell2">
										...
										<button class="buttonSubmit"
											@click="openNameModal('nickName')">별명 변경</button>
									</div>
								</div>
								...
								<div class="row"
									...
									<div style="font-size: 13px; color: #747171;">
	...
	var app = new Vue(
			{
				...
				methods : {
					...
					fnSubmit : function(map) {
						...
						/* 이메일 변경시 */
						let email = /^[a-zA-Z0-9]*$/;
						let emailAddr = /^[\w-]+(\.[\w-]+)*(\.[a-zA-Z]{2,})$/;						
						if (self.modalType == "email") {
							if (self.email == "" || self.emailAddr == "") {
							...
							if(!emailAddr.test(self.emailAddr)){
						...
						let nickName = /^[a-zA-Z0-9가-힣]+$/;
						/* 닉네임 변경시 */
						if(self.modalType=="nickName"){
							if(!nickName.test(self.changeValue)){
